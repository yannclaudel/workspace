...
public class Measurement {
	...
	public double getLuDistance() {
		return Math.sqrt(Math.pow(Double.parseDouble(latitude) - 49.608100, 2)
				+ Math.pow(Double.parseDouble(longitude) - 6.128466, 2));
	}
	...
	public String toString() {
		return "Measurement " + getLuDistance() + " [id=" + id + ", measurementTime=" + measurementTime + ", latitude="
				+ latitude + ", longitude=" + longitude + ", direction=" + direction + ", road=" + road
				+ ", averageVehicleSpeed=" + averageVehicleSpeed + ", vehicleFlowRate=" + vehicleFlowRate
				+ ", trafficConcentration=" + trafficConcentration + "]";
	}

	public String print(String sep) {
		return id + sep + measurementTime + sep + latitude + sep + longitude + sep + direction + sep + road + sep
				+ averageVehicleSpeed + sep + vehicleFlowRate + sep + trafficConcentration + "\n";
	}
